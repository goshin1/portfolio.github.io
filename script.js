    ...
    const projectInfo = {
        "Depatorium" : {
            ...
            "explain" : "- 프로젝트의 UI/UX 디자인 설계 및 구현<br/>\
                        ...
                        사용자를 만족하게 하기 위해서는 다양한 기능을 제공하는 것보다, 당연함을 제공하는 것이 중요하다는 것을 알 수 있었습니다.<br/>\
                        예를 들어 로그인하고 나서 브라우저를 닫아도 로그인 유지가 되거나, 사용자가 서버에게 요청할 때 검증 과정을 통해<br/>\
                        보안을 높여야 한다는 점을 알 수 있었습니다. 나무를 보다 숲을 놓치지 말 것이라는 교훈을 얻었습니다",
        ...
        "영어단어정복ABC" : {
            ...
            "explain" : "- 회원 별 영어 단어장 제공<br/>\
                        ...
                        모바일에서 사용할 때 간단하게 한손으로 간단하게 조작하기 위해서는 어떻게 구현해야 할지 알 수 있었습니다.<br/>\
                        단순히 UI/UX 디자인만 고려하는 것이 아닌 서버에서는 어떤 기능을 해야 할지 프론트엔드에서는 무엇을 할지<br/>\
                        정확히 역할을 구분하여 구현해야 한다는 점을 알 수 있었습니다.<br/>\
                        예를 들어 단어를 편집할 때 프론트엔드에서는 변경 사항과 변경될 단어의 기본적인 정보만 주어,<br/>\
                        브라우저에 부담이 안 되게 하고, 서버에서는 사용자의 요청에 응답하여 프론트엔드에서 바로 사용할 수 <br/>\
                        있게 정보를 처리하여 지연시간을 줄이게 만드는 듯 프론트엔드와 백엔드에 역할 구분의 중요성을 알 수 있었습니다.",
        ...
        "universocial" : {
            ...
            "explain" : "- 프로젝트의 UI/UX 디자인 설계 및 구현<br/>\
                        ...
                        관리자는 다른 사람의 회원 정보를 변경, 삭제하는 과정에서 다른 팀원이 담당한 기능과 연계되었습니다.<br/>\
                        그래서 기능을 구현하기 위해 다른 기능들을 파악했어야 했습니다. 이 문제를 해결하기 위해 팀원과 서로<br/>\
                        작업한 내용을 나누는 시간을 가지게 되었고, 이후 주기적으로 회의를 하게되어 프로젝트를 원활하게 마칠 수 있었습니다.<br/>\
                        이를 통해 팀원간의 소통이 얼마나 중요한지 알 수 있었습니다.",
